...
async function main() {
  ...
  // and nav-sort.ts is imported by the layout, so both have to travel with them
  // or the build fails on a missing module.
  for (const file of ['quartz.config.ts', 'quartz.layout.ts', 'op-site.ts', 'nav-sort.ts']) {
