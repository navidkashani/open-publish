...
**Settings → Open Publish → Appearance → Customize navigation → Manage** does
the same without touching your notes. Drag a row, or use its Move up and Move
down buttons; on a phone, long-press it. A page moves only among its own siblings,
